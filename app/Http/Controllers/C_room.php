...
class C_room extends Controller
{
    ...
    public function pageRoom($id = null){
        ...
        return view('cpanel.pages.room.index')->with($response);
    }

    public function form($id = null){
        $data = [];
        if($id !== null){
            $query = M_room::where("id_room", "=", $id)->get();
            $data = $query;
        }
        $response = app(\App\Http\Controllers\C_pages::class)->returnTemplate("Formulir", $data);
        return view('cpanel.pages.room.form')->with($response);
    }
    ...
    public function getStore($id = null){
        ...
        if($id == null){
            ...
            $query = M_room::where("id_room", "=", $id)->orderBy("created_at", "desc")->get();
        }
        $response['data'] = $query;
