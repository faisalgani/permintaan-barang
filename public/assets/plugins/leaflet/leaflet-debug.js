...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet')) : typeof define === 'function' && define.amd ? define(['exports', 'leaflet'], factory) : (factory((global.L = global.L || {},
    global.L.esri = global.L.esri || {}), global.L));
    ...
    function convertRingsToGeoJSON(rings) {
        ...
        // iterator
        var outerRing;
        // current outer ring being evaluated
        var hole;
        // current hole being evaluated
    ...
    function _updateMapAttribution(evt) {
        ...
        if (map && map.attributionControl && oldAttributions) {
            ...
            var wrappedBounds = L$1.latLngBounds(bounds.getSouthWest().wrap(), bounds.getNorthEast().wrap());
    ...
    var Query = Task.extend({
        ...
        within: function(geometry) {
            ...
            // to the REST api this reads geometry **contains** layer
            return this;
        },
        ...
        contains: function(geometry) {
            ...
            // to the REST api this reads geometry **within** layer
            return this;
        },
    ...
    var VirtualGrid = L$1__default.Layer.extend({
        ...
        _update: function() {
            ...
            var cellBounds = L$1__default.bounds(bounds.min.divideBy(cellSize).floor(), bounds.max.divideBy(cellSize).floor());
        ...
        _getCellNumBounds: function() {
            ...
            return bounds ? L$1__default.bounds(bounds.min.divideBy(size).floor(), bounds.max.divideBy(size).ceil().subtract([1, 1])) : null;
        }
    });
