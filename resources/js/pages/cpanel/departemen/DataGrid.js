...
export default class DataGrid extends Component {
    ...
    async componentDidMount() {
        var $this = this;
        await this.setState({
            datatable: await $('#dataDepartemen').DataTable({
                "processing": true,
                "serverSide": true,
                "scrollX"   : true,
                "scrollY"   : true,
                "ajax" 		: this.state.url+"/api/v1/departemen/read",
                ...
                "columns": [
                    ...
                    },            
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            '<a data-toggle="tooltip" data-placement="bottom" title="Kelola" href="'+$this.state.url+'/admin/departemen/form/'+row.id+'" class="btn btn btn-default btn-sm"><i class="far fa-edit"></i></a>'+
        ...
        $('#dataDepartemen tbody').on( 'click', 'button', async function (e) {
    ...
    render() {
        ...
        return (
            <>
                ...
                <table id="dataDepartemen" width="100%" className="table table-bordered table-hover">
                    <thead>
                    <tr>
...
if (document.getElementById('cpanel-departemen-datagrid')) {
    const app = document.getElementById('cpanel-departemen-datagrid');
    ReactDOM.render(<DataGrid {...app.dataset}/>, document.getElementById('cpanel-departemen-datagrid'));
}
