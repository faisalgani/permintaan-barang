    ...
    async componentDidMount() {
        ...
        await this.setState({
            datatable: await $('#dataGroup').DataTable({
                ...
                "scrollX"   : true,
                "scrollY"   : true,
                "ajax" 		: this.state.url+"/api/v1/system_role/read",
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            '<button class="btn btn-default btn-sm" data-name="update-group" data-id="'+row.id+'" data-group="'+row.role+'" data-active="'+row.active+'"><i class="fa fa-file"></i></button>'+
...
if (document.getElementById('cpanel-system_role-datagrid')) {
    const app = document.getElementById('cpanel-system_role-datagrid');
    ReactDOM.render(<DataGrid {...app.dataset}/>, document.getElementById('cpanel-system_role-datagrid'));
}
