...
export default class DataGrid extends Component {
    ...
    async componentDidMount() {
        var $this = this;
        await this.setState({
            datatable: await $('#dataCustomer').DataTable({
                "processing": true,
                "serverSide": true,
                "scrollX"   : true,
                "scrollY"   : true,
                "ajax" 		: this.state.url+"/api/v1/customer/read",
                ...
                "columns": [
                    ...
                    { 
                        "data": "customer_to_departemen.nama_departemen",
                        "width": "20%",
                    },
        ...
        $('#dataCustomer tbody').on( 'click', 'button', async function (e) {
            if($(this)[0].dataset.name == "delete-customer"){
                await Swal.fire({
    ...
    render() {
        ...
        return (
            <>
                ...
                <table id="dataCustomer" width="100%" className="table table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>Nama</th>
                        <th>NIK</th>
...
if (document.getElementById('cpanel-customer-datagrid')) {
    const app = document.getElementById('cpanel-customer-datagrid');
    ReactDOM.render(<DataGrid {...app.dataset}/>, document.getElementById('cpanel-customer-datagrid'));
}
