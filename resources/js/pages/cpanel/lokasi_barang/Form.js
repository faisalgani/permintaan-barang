...
export default class Form extends Component {
            ...
            if (result.isConfirmed) {
                ...
                if(typeof(result.code) !== 'undefined'){
                    if(result.code == 200){
                        ...
                        setTimeout(() => {
                            window.location.href = $this.state.url+"/admin/lokasi_barang";
                        }, 1000);
                    }else{
    ...
    async btnSave(){
       ...
       // console.log($("#id").val());
        if(this.state.process == "create"){
            let result = await ExternalAPI.post(
                this.state.url+'/api/v1/lokasi_barang/create', 
                this.state.header, 
            ...
            let result = await ExternalAPI.post(
                this.state.url+'/api/v1/lokasi_barang/update', 
                this.state.header, 
                await encryptParameter(await this.getParams()));
    ...
    async componentDidMount() {
        ...
        if(this.state.parameter.lokasi !== ""){
            this.setState({
                lokasi: this.state.parameter.lokasi, 
            });
            $("#lokasi").val(this.state.parameter.lokasi);
        }
                                    ...
                                    <div className="card card-default">
                                        <div className="card-body">
                                            <div className="form-group">
                                                ...
                                                <input type="text" defaultValue={this.state.name}  className={"form-control"} id="lokasi" name="lokasi" />
                                            </div>
...
if (document.getElementById('cpanel-lokasi-barang-form')) {
    const app = document.getElementById('cpanel-lokasi-barang-form');
    ReactDOM.render(<Form {...app.dataset}/>, document.getElementById('cpanel-lokasi-barang-form'));
}
