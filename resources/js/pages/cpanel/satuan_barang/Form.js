...
export default class Form extends Component {
            ...
            if (result.isConfirmed) {
                ...
                if(typeof(result.code) !== 'undefined'){
                    if(result.code == 200){
                        ...
                        setTimeout(() => {
                            window.location.href = $this.state.url+"/admin/satuan_barang";
                        }, 1000);
                    }else{
    ...
    async btnSave(){
       ...
       // console.log($("#id").val());
        if(this.state.process == "create"){
            let result = await ExternalAPI.post(
                this.state.url+'/api/v1/satuan_barang/create', 
                this.state.header, 
            ...
            let result = await ExternalAPI.post(
                this.state.url+'/api/v1/satuan_barang/update', 
                this.state.header, 
                await encryptParameter(await this.getParams()));
    ...
    async componentDidMount() {
        ...
        if(this.state.parameter.nama_satuan !== ""){
            this.setState({
                nama_satuan: this.state.parameter.nama_satuan, 
            });
            $("#nama_satuan").val(this.state.parameter.nama_satuan);
        }
                                    ...
                                    <div className="card card-default">
                                        <div className="card-body">
                                            <div className="form-group">
                                                ...
                                                <input type="text" defaultValue={this.state.nama_satuan}  className={"form-control"} id="satuan" name="satuan" />
                                            </div>
...
if (document.getElementById('cpanel-satuan-barang-form')) {
    const app = document.getElementById('cpanel-satuan-barang-form');
    ReactDOM.render(<Form {...app.dataset}/>, document.getElementById('cpanel-satuan-barang-form'));
}
